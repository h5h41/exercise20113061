...
-(id)init
{
    ...
    if (self) {
        ...
        NSMutableArray *marray=[NSMutableArray arrayWithObjects:@"刘庆轩",@"15899877789",@"马健",@"13146132587",@"马海龙",@"975807058",@"张剑",@"446716505",@"张伟",@"15143163210",@"刘洋",@"15146315264",@"Allen",@"未知", nil];
